...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['ImBurger',	'Burguer',	'Director, Main Animator',	'https://twitter.com/MBorgor',	'0000FF'],
			...
			['Viva', 'Viva', 'Charter', 'https://twitter.com/Vivaderus', '163f37'],
			['MindOfTheEye', 'MOTE',	'Musician', 'https://twitter.com/MindoftheEye1', '1E1B1B'],
			...
			['Nautical', 'nautical', "Ui artist", 'https://twitter.com/nauticallll', 'E2FEE2'],
			['Vibe', 'vibe', 'Coder, and video editor for F3 trailer', 'https://twitter.com/Vibe_67', '301934'],
			['Scatt', 'scatt', 'logo creator', 'https://twitter.com/Scatt70857891', '3730F9'],
